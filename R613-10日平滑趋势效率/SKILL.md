---
name: quant-real-factor-10d-smoothed-trend-efficiency
description: Use when computing the 10D Smoothed Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Trend Efficiency

Use this Skill to compute `10日平滑趋势效率` / `10D Smoothed Trend Efficiency` from caller-provided OHLCV data.
