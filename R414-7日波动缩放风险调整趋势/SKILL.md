---
name: quant-real-factor-7d-volatility-scaled-risk-adjusted-trend
description: Use when computing the 7D Volatility Scaled Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled Risk-Adjusted Trend

Use this Skill to compute `7日波动缩放风险调整趋势` / `7D Volatility Scaled Risk-Adjusted Trend` from caller-provided OHLCV data.
