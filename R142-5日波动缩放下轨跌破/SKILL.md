---
name: quant-real-factor-5d-volatility-scaled-lower-breakdown
description: Use when computing the 5D Volatility Scaled Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Lower Breakdown

Use this Skill to compute `5日波动缩放下轨跌破` / `5D Volatility Scaled Lower Breakdown` from caller-provided OHLCV data.
