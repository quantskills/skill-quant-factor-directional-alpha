---
name: quant-real-factor-7d-z-scored-trend-efficiency
description: Use when computing the 7D Z-Scored Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Trend Efficiency

Use this Skill to compute `7日标准化趋势效率` / `7D Z-Scored Trend Efficiency` from caller-provided OHLCV data.
