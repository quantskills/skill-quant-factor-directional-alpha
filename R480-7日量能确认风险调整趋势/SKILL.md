---
name: quant-real-factor-7d-volume-confirmed-risk-adjusted-trend
description: Use when computing the 7D Volume Confirmed Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日量能确认风险调整趋势` / `7D Volume Confirmed Risk-Adjusted Trend` from caller-provided OHLCV data.
