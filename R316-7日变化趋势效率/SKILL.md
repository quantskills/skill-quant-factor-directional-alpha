---
name: quant-real-factor-7d-delta-trend-efficiency
description: Use when computing the 7D Delta Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Trend Efficiency

Use this Skill to compute `7日变化趋势效率` / `7D Delta Trend Efficiency` from caller-provided OHLCV data.
