---
name: quant-real-factor-10d-z-scored-trend-efficiency
description: Use when computing the 10D Z-Scored Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Trend Efficiency

Use this Skill to compute `10日标准化趋势效率` / `10D Z-Scored Trend Efficiency` from caller-provided OHLCV data.
