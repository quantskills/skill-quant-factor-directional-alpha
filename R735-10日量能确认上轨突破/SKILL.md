---
name: quant-real-factor-10d-volume-confirmed-upper-breakout
description: Use when computing the 10D Volume Confirmed Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日量能确认上轨突破` / `10D Volume Confirmed Upper Breakout` from caller-provided OHLCV data.
