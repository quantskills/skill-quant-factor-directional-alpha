---
name: quant-real-factor-10d-stability-scaled-lower-breakdown
description: Use when computing the 10D Stability Scaled Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Lower Breakdown

Use this Skill to compute `10日稳定度缩放下轨跌破` / `10D Stability Scaled Lower Breakdown` from caller-provided OHLCV data.
