---
name: quant-real-factor-7d-volume-confirmed-trend-efficiency
description: Use when computing the 7D Volume Confirmed Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Trend Efficiency

Use this Skill to compute `7日量能确认趋势效率` / `7D Volume Confirmed Trend Efficiency` from caller-provided OHLCV data.
