---
name: quant-real-factor-7d-stability-scaled-return-momentum
description: Use when computing the 7D Stability Scaled Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Return Momentum

Use this Skill to compute `7日稳定度缩放收益动量` / `7D Stability Scaled Return Momentum` from caller-provided OHLCV data.
