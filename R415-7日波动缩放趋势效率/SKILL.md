---
name: quant-real-factor-7d-volatility-scaled-trend-efficiency
description: Use when computing the 7D Volatility Scaled Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled Trend Efficiency

Use this Skill to compute `7日波动缩放趋势效率` / `7D Volatility Scaled Trend Efficiency` from caller-provided OHLCV data.
