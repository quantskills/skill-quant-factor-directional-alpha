---
name: quant-real-factor-5d-smoothed-lower-breakdown
description: Use when computing the 5D Smoothed Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Lower Breakdown

Use this Skill to compute `5日平滑下轨跌破` / `5D Smoothed Lower Breakdown` from caller-provided OHLCV data.
