---
name: quant-real-factor-10d-time-series-ranked-risk-adjusted-trend
description: Use when computing the 10D Time-Series Ranked Risk-Adjusted Trend factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
