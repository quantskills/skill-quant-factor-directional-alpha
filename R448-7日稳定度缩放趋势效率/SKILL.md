---
name: quant-real-factor-7d-stability-scaled-trend-efficiency
description: Use when computing the 7D Stability Scaled Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Trend Efficiency

Use this Skill to compute `7日稳定度缩放趋势效率` / `7D Stability Scaled Trend Efficiency` from caller-provided OHLCV data.
