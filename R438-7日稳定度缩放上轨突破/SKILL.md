---
name: quant-real-factor-7d-stability-scaled-upper-breakout
description: Use when computing the 7D Stability Scaled Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Upper Breakout

Use this Skill to compute `7日稳定度缩放上轨突破` / `7D Stability Scaled Upper Breakout` from caller-provided OHLCV data.
