...
`5日标准化下轨跌破` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `突破` 类。

### 因子逻辑

```text
z(breakdown, window=5)
```
...
- 可用行数: `195307`
- 覆盖率: `0.9917`
- 5日 Rank IC 均值: `0.000071`
- 5日 ICIR: `0.0026`
- 五分组 Q5-Q1 均值: `-0.000459`
- Top 组换手: `0.5039`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Z-Scored Lower Breakdown` is a real-data-validated framework-neutral OHLCV factor Skill in the `Breakout` family.
...
- Usable rows: `195307`
- Coverage: `0.9917`
- 5-day Rank IC mean: `0.000071`
- 5-day ICIR: `0.0026`
- Quintile Q5-Q1 mean: `-0.000459`
- Top-quintile turnover: `0.5039`
