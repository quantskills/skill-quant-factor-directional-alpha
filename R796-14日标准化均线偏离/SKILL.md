---
name: quant-real-factor-14d-z-scored-sma-gap
description: Use when computing the 14D Z-Scored SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 14D Z-Scored SMA Gap

Use this Skill to compute `14日标准化均线偏离` / `14D Z-Scored SMA Gap` from caller-provided OHLCV data.
