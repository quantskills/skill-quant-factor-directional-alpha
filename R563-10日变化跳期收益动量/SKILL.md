---
name: quant-real-factor-10d-delta-skip-period-momentum
description: Use when computing the 10D Delta Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Skip-Period Momentum

Use this Skill to compute `10日变化跳期收益动量` / `10D Delta Skip-Period Momentum` from caller-provided OHLCV data.
