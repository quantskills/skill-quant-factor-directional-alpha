...
`5日变化双EMA趋势差` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `趋势` 类。

### 因子逻辑

```text
delta(dual_ema_gap, window=5)
```
...
`5D Delta Dual EMA Gap` is a real-data-validated framework-neutral OHLCV factor Skill in the `Trend` family.
...
- Usable rows: `195899`
- Coverage: `0.9947`
- 5-day Rank IC mean: `-0.011215`
- 5-day ICIR: `-0.3725`
- Quintile Q5-Q1 mean: `-0.001237`
- Top-quintile turnover: `0.6768`
