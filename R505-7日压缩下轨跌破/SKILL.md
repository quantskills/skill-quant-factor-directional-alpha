---
name: quant-real-factor-7d-compressed-lower-breakdown
description: Use when computing the 7D Compressed Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Lower Breakdown

Use this Skill to compute `7日压缩下轨跌破` / `7D Compressed Lower Breakdown` from caller-provided OHLCV data.
