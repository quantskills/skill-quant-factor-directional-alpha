---
name: quant-real-factor-10d-compressed-sma-gap
description: Use when computing the 10D Compressed SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed SMA Gap

Use this Skill to compute `10日压缩均线偏离` / `10D Compressed SMA Gap` from caller-provided OHLCV data.
