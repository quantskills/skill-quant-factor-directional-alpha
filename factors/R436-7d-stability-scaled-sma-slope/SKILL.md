---
name: quant-real-factor-7d-stability-scaled-sma-slope
description: Use when computing the 7D Stability Scaled SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled SMA Slope

Use this Skill to compute `7日稳定度缩放均线斜率` / `7D Stability Scaled SMA Slope` from caller-provided OHLCV data.
