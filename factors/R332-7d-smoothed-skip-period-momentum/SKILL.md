---
name: quant-real-factor-7d-smoothed-skip-period-momentum
description: Use when computing the 7D Smoothed Skip-Period Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Skip-Period Momentum

Use this Skill to compute `7日平滑跳期收益动量` / `7D Smoothed Skip-Period Momentum` from caller-provided OHLCV data.
