---
name: quant-real-factor-10d-volatility-scaled-ema-gap
description: Use when computing the 10D Volatility Scaled EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled EMA Gap

Use this Skill to compute `10日波动缩放EMA偏离` / `10D Volatility Scaled EMA Gap` from caller-provided OHLCV data.
