---
name: quant-real-factor-5d-smoothed-risk-adjusted-trend
description: Use when computing the 5D Smoothed Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Risk-Adjusted Trend

Use this Skill to compute `5日平滑风险调整趋势` / `5D Smoothed Risk-Adjusted Trend` from caller-provided OHLCV data.
