---
name: quant-real-factor-5d-volatility-scaled-sma-slope
description: Use when computing the 5D Volatility Scaled SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled SMA Slope

Use this Skill to compute `5日波动缩放均线斜率` / `5D Volatility Scaled SMA Slope` from caller-provided OHLCV data.
