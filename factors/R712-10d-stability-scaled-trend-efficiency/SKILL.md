---
name: quant-real-factor-10d-stability-scaled-trend-efficiency
description: Use when computing the 10D Stability Scaled Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Trend Efficiency

Use this Skill to compute `10日稳定度缩放趋势效率` / `10D Stability Scaled Trend Efficiency` from caller-provided OHLCV data.
