...
`7日压缩上轨突破` 是一个框架中立的 OHLCV 因子 Skill，属于 `突破` 类。它只依赖用户传入的行情字段，不绑定任何交易框架或数据供应商。

### 因子逻辑

```text
compress(breakout, window=7)
```
...
- 市场覆盖: `{"cn": 98, "us": 50}`
- 覆盖率: `0.9940`
- 5日 Rank IC 均值: `0.024877`
- 5日 ICIR: `0.8217`
- 五分组 Q5-Q1 均值: `0.000922`
- Top 组换手: `0.4737`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Compressed Upper Breakout` is a framework-neutral OHLCV factor Skill in the `Breakout` family. It depends only on caller-supplied market fields and is not tied to any trading framework or data vendor.
...
- Markets: `{"cn": 98, "us": 50}`
- Coverage: `0.9940`
- 5-day Rank IC mean: `0.024877`
- 5-day ICIR: `0.8217`
- Quintile Q5-Q1 mean: `0.000922`
- Top-quintile turnover: `0.4737`
