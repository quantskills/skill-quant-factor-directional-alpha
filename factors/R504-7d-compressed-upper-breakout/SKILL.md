---
name: quant-real-factor-7d-compressed-upper-breakout
description: Use when computing the 7D Compressed Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Upper Breakout

Use this Skill to compute `7日压缩上轨突破` / `7D Compressed Upper Breakout` from caller-provided OHLCV data.
