---
name: quant-real-factor-10d-compressed-range-position
description: Use when computing the 10D Compressed Range Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
