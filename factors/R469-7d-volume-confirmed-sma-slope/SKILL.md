---
name: quant-real-factor-7d-volume-confirmed-sma-slope
description: Use when computing the 7D Volume Confirmed SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed SMA Slope

Use this Skill to compute `7日量能确认均线斜率` / `7D Volume Confirmed SMA Slope` from caller-provided OHLCV data.
