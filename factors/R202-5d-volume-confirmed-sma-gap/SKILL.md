---
name: quant-real-factor-5d-volume-confirmed-sma-gap
description: Use when computing the 5D Volume Confirmed SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed SMA Gap

Use this Skill to compute `5日量能确认均线偏离` / `5D Volume Confirmed SMA Gap` from caller-provided OHLCV data.
