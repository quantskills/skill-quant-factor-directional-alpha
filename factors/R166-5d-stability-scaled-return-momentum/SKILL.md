---
name: quant-real-factor-5d-stability-scaled-return-momentum
description: Use when computing the 5D Stability Scaled Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Return Momentum

Use this Skill to compute `5日稳定度缩放收益动量` / `5D Stability Scaled Return Momentum` from caller-provided OHLCV data.
