---
name: quant-real-factor-10d-volatility-scaled-upper-breakout
description: Use when computing the 10D Volatility Scaled Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Upper Breakout

Use this Skill to compute `10日波动缩放上轨突破` / `10D Volatility Scaled Upper Breakout` from caller-provided OHLCV data.
