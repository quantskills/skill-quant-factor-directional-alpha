---
name: quant-real-factor-7d-smoothed-sma-slope
description: Use when computing the 7D Smoothed SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed SMA Slope

Use this Skill to compute `7日平滑均线斜率` / `7D Smoothed SMA Slope` from caller-provided OHLCV data.
