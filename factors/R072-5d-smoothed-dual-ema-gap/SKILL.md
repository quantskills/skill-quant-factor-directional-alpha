---
name: quant-real-factor-5d-smoothed-dual-ema-gap
description: Use when computing the 5D Smoothed Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Dual EMA Gap

Use this Skill to compute `5日平滑双EMA趋势差` / `5D Smoothed Dual EMA Gap` from caller-provided OHLCV data.
