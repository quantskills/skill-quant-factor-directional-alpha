---
name: quant-real-factor-7d-z-scored-risk-adjusted-trend
description: Use when computing the 7D Z-Scored Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Risk-Adjusted Trend

Use this Skill to compute `7日标准化风险调整趋势` / `7D Z-Scored Risk-Adjusted Trend` from caller-provided OHLCV data.
