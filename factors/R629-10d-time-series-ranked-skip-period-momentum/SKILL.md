---
name: quant-real-factor-10d-time-series-ranked-skip-period-momentum
description: Use when computing the 10D Time-Series Ranked Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Skip-Period Momentum

Use this Skill to compute `10日时序排名跳期收益动量` / `10D Time-Series Ranked Skip-Period Momentum` from caller-provided OHLCV data.
