---
name: quant-real-factor-14d-z-scored-sma-slope
description: Use when computing the 14D Z-Scored SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 14D Z-Scored SMA Slope

Use this Skill to compute `14日标准化均线斜率` / `14D Z-Scored SMA Slope` from caller-provided OHLCV data.
