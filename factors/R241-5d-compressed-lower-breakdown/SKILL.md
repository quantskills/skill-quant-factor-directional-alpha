---
name: quant-real-factor-5d-compressed-lower-breakdown
description: Use when computing the 5D Compressed Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Lower Breakdown

Use this Skill to compute `5日压缩下轨跌破` / `5D Compressed Lower Breakdown` from caller-provided OHLCV data.
