---
name: quant-real-factor-5d-smoothed-return-momentum
description: Use when computing the 5D Smoothed Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Return Momentum

Use this Skill to compute `5日平滑收益动量` / `5D Smoothed Return Momentum` from caller-provided OHLCV data.
