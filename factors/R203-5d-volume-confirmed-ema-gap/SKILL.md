---
name: quant-real-factor-5d-volume-confirmed-ema-gap
description: Use when computing the 5D Volume Confirmed EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed EMA Gap

Use this Skill to compute `5日量能确认EMA偏离` / `5D Volume Confirmed EMA Gap` from caller-provided OHLCV data.
