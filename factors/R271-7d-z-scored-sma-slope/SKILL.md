---
name: quant-real-factor-7d-z-scored-sma-slope
description: Use when computing the 7D Z-Scored SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored SMA Slope

Use this Skill to compute `7日标准化均线斜率` / `7D Z-Scored SMA Slope` from caller-provided OHLCV data.
