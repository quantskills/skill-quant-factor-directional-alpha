---
name: quant-real-factor-7d-compressed-return-momentum
description: Use when computing the 7D Compressed Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Return Momentum

Use this Skill to compute `7日压缩收益动量` / `7D Compressed Return Momentum` from caller-provided OHLCV data.
