---
name: quant-real-factor-10d-volatility-scaled-return-reversal
description: Use when computing the 10D Volatility Scaled Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Return Reversal

Use this Skill to compute `10日波动缩放收益反转` / `10D Volatility Scaled Return Reversal` from caller-provided OHLCV data.
