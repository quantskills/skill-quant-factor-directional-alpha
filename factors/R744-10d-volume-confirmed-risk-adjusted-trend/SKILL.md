---
name: quant-real-factor-10d-volume-confirmed-risk-adjusted-trend
description: Use when computing the 10D Volume Confirmed Risk-Adjusted Trend factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Risk-Adjusted Trend

Use this Skill to compute `10日量能确认风险调整趋势` / `10D Volume Confirmed Risk-Adjusted Trend` from caller-provided OHLCV data.
