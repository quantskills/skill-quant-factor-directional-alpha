---
name: quant-real-factor-10d-volatility-scaled-lower-breakdown
description: Use when computing the 10D Volatility Scaled Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Lower Breakdown

Use this Skill to compute `10日波动缩放下轨跌破` / `10D Volatility Scaled Lower Breakdown` from caller-provided OHLCV data.
