---
name: quant-real-factor-10d-volume-confirmed-lower-breakdown
description: Use when computing the 10D Volume Confirmed Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Lower Breakdown

Use this Skill to compute `10日量能确认下轨跌破` / `10D Volume Confirmed Lower Breakdown` from caller-provided OHLCV data.
