---
name: quant-real-factor-10d-smoothed-upper-breakout
description: Use when computing the 10D Smoothed Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Upper Breakout

Use this Skill to compute `10日平滑上轨突破` / `10D Smoothed Upper Breakout` from caller-provided OHLCV data.
