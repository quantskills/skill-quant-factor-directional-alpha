---
name: quant-real-factor-5d-volatility-scaled-upper-breakout
description: Use when computing the 5D Volatility Scaled Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Upper Breakout

Use this Skill to compute `5日波动缩放上轨突破` / `5D Volatility Scaled Upper Breakout` from caller-provided OHLCV data.
