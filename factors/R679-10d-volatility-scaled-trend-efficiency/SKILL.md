---
name: quant-real-factor-10d-volatility-scaled-trend-efficiency
description: Use when computing the 10D Volatility Scaled Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Trend Efficiency

Use this Skill to compute `10日波动缩放趋势效率` / `10D Volatility Scaled Trend Efficiency` from caller-provided OHLCV data.
