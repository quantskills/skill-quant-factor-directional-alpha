---
name: quant-real-factor-10d-volume-confirmed-return-momentum
description: Use when computing the 10D Volume Confirmed Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Return Momentum

Use this Skill to compute `10日量能确认收益动量` / `10D Volume Confirmed Return Momentum` from caller-provided OHLCV data.
