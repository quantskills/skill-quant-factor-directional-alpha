---
name: quant-real-factor-10d-smoothed-range-position
description: Use when computing the 10D Smoothed Range Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Range Position

Use this Skill to compute `10日平滑区间位置` / `10D Smoothed Range Position` from caller-provided OHLCV data.
