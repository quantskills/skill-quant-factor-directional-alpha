---
name: quant-real-factor-5d-stability-scaled-sma-gap
description: Use when computing the 5D Stability Scaled SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled SMA Gap

Use this Skill to compute `5日稳定度缩放均线偏离` / `5D Stability Scaled SMA Gap` from caller-provided OHLCV data.
