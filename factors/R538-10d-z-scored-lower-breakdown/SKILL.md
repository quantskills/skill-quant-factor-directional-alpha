---
name: quant-real-factor-10d-z-scored-lower-breakdown
description: Use when computing the 10D Z-Scored Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Lower Breakdown

Use this Skill to compute `10日标准化下轨跌破` / `10D Z-Scored Lower Breakdown` from caller-provided OHLCV data.
