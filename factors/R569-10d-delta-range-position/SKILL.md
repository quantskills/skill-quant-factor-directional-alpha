---
name: quant-real-factor-10d-delta-range-position
description: Use when computing the 10D Delta Range Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Range Position

Use this Skill to compute `10日变化区间位置` / `10D Delta Range Position` from caller-provided OHLCV data.
