---
name: quant-real-factor-10d-delta-return-momentum
description: Use when computing the 10D Delta Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Return Momentum

Use this Skill to compute `10日变化收益动量` / `10D Delta Return Momentum` from caller-provided OHLCV data.
