---
name: quant-real-factor-14d-z-scored-return-reversal
description: Use when computing the 14D Z-Scored Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 14D Z-Scored Return Reversal

Use this Skill to compute `14日标准化收益反转` / `14D Z-Scored Return Reversal` from caller-provided OHLCV data.
