---
name: quant-real-factor-7d-stability-scaled-lower-breakdown
description: Use when computing the 7D Stability Scaled Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Lower Breakdown

Use this Skill to compute `7日稳定度缩放下轨跌破` / `7D Stability Scaled Lower Breakdown` from caller-provided OHLCV data.
