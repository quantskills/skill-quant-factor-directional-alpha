---
name: quant-real-factor-10d-volume-confirmed-sma-gap
description: Use when computing the 10D Volume Confirmed SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed SMA Gap

Use this Skill to compute `10日量能确认均线偏离` / `10D Volume Confirmed SMA Gap` from caller-provided OHLCV data.
