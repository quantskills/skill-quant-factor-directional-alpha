---
name: quant-real-factor-10d-z-scored-upper-breakout
description: Use when computing the 10D Z-Scored Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Upper Breakout

Use this Skill to compute `10日标准化上轨突破` / `10D Z-Scored Upper Breakout` from caller-provided OHLCV data.
