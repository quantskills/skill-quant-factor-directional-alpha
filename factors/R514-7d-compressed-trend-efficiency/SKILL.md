---
name: quant-real-factor-7d-compressed-trend-efficiency
description: Use when computing the 7D Compressed Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Trend Efficiency

Use this Skill to compute `7日压缩趋势效率` / `7D Compressed Trend Efficiency` from caller-provided OHLCV data.
