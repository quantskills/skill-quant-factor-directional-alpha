---
name: quant-real-factor-7d-delta-return-reversal
description: Use when computing the 7D Delta Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Return Reversal

Use this Skill to compute `7日变化收益反转` / `7D Delta Return Reversal` from caller-provided OHLCV data.
