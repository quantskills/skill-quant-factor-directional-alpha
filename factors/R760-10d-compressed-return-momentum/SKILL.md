---
name: quant-real-factor-10d-compressed-return-momentum
description: Use when computing the 10D Compressed Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Return Momentum

Use this Skill to compute `10日压缩收益动量` / `10D Compressed Return Momentum` from caller-provided OHLCV data.
