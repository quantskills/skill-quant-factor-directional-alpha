---
name: quant-real-factor-10d-delta-return-reversal
description: Use when computing the 10D Delta Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Return Reversal

Use this Skill to compute `10日变化收益反转` / `10D Delta Return Reversal` from caller-provided OHLCV data.
