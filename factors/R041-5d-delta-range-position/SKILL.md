---
name: quant-real-factor-5d-delta-range-position
description: Use when computing the 5D Delta Range Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Range Position

Use this Skill to compute `5日变化区间位置` / `5D Delta Range Position` from caller-provided OHLCV data.
