---
name: quant-real-factor-10d-smoothed-sma-gap
description: Use when computing the 10D Smoothed SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed SMA Gap

Use this Skill to compute `10日平滑均线偏离` / `10D Smoothed SMA Gap` from caller-provided OHLCV data.
