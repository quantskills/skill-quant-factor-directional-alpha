---
name: quant-real-factor-5d-z-scored-return-reversal
description: Use when computing the 5D Z-Scored Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Return Reversal

Use this Skill to compute `5日标准化收益反转` / `5D Z-Scored Return Reversal` from caller-provided OHLCV data.
