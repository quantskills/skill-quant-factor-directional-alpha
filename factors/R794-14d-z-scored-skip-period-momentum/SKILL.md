---
name: quant-real-factor-14d-z-scored-skip-period-momentum
description: Use when computing the 14D Z-Scored Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 14D Z-Scored Skip-Period Momentum

Use this Skill to compute `14日标准化跳期收益动量` / `14D Z-Scored Skip-Period Momentum` from caller-provided OHLCV data.
