---
name: quant-real-factor-7d-delta-ema-gap
description: Use when computing the 7D Delta EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化EMA偏离` / `7D Delta EMA Gap` from caller-provided OHLCV data.
