---
name: quant-real-factor-10d-volatility-scaled-sma-slope
description: Use when computing the 10D Volatility Scaled SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled SMA Slope

Use this Skill to compute `10日波动缩放均线斜率` / `10D Volatility Scaled SMA Slope` from caller-provided OHLCV data.
