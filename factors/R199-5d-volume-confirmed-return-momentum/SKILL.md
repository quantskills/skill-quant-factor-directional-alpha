---
name: quant-real-factor-5d-volume-confirmed-return-momentum
description: Use when computing the 5D Volume Confirmed Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Return Momentum

Use this Skill to compute `5日量能确认收益动量` / `5D Volume Confirmed Return Momentum` from caller-provided OHLCV data.
