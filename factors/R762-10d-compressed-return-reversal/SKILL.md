---
name: quant-real-factor-10d-compressed-return-reversal
description: Use when computing the 10D Compressed Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Return Reversal

Use this Skill to compute `10日压缩收益反转` / `10D Compressed Return Reversal` from caller-provided OHLCV data.
