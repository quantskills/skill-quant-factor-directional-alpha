---
name: quant-real-factor-10d-volume-confirmed-trend-efficiency
description: Use when computing the 10D Volume Confirmed Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Trend Efficiency

Use this Skill to compute `10日量能确认趋势效率` / `10D Volume Confirmed Trend Efficiency` from caller-provided OHLCV data.
