---
name: quant-real-factor-5d-volume-confirmed-upper-breakout
description: Use when computing the 5D Volume Confirmed Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Upper Breakout

Use this Skill to compute `5日量能确认上轨突破` / `5D Volume Confirmed Upper Breakout` from caller-provided OHLCV data.
