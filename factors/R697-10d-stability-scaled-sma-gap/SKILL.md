---
name: quant-real-factor-10d-stability-scaled-sma-gap
description: Use when computing the 10D Stability Scaled SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled SMA Gap

Use this Skill to compute `10日稳定度缩放均线偏离` / `10D Stability Scaled SMA Gap` from caller-provided OHLCV data.
