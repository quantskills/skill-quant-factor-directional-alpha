---
name: quant-real-factor-7d-volatility-scaled-dual-ema-gap
description: Use when computing the 7D Volatility Scaled Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled Dual EMA Gap

Use this Skill to compute `7日波动缩放双EMA趋势差` / `7D Volatility Scaled Dual EMA Gap` from caller-provided OHLCV data.
