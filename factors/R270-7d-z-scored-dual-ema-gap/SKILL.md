---
name: quant-real-factor-7d-z-scored-dual-ema-gap
description: Use when computing the 7D Z-Scored Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Dual EMA Gap

Use this Skill to compute `7日标准化双EMA趋势差` / `7D Z-Scored Dual EMA Gap` from caller-provided OHLCV data.
