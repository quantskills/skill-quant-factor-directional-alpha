---
name: quant-real-factor-7d-stability-scaled-skip-period-momentum
description: Use when computing the 7D Stability Scaled Skip-Period Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Skip-Period Momentum

Use this Skill to compute `7日稳定度缩放跳期收益动量` / `7D Stability Scaled Skip-Period Momentum` from caller-provided OHLCV data.
