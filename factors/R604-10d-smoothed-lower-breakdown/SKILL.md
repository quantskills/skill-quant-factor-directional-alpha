---
name: quant-real-factor-10d-smoothed-lower-breakdown
description: Use when computing the 10D Smoothed Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Lower Breakdown

Use this Skill to compute `10日平滑下轨跌破` / `10D Smoothed Lower Breakdown` from caller-provided OHLCV data.
