---
name: quant-real-factor-10d-stability-scaled-return-momentum
description: Use when computing the 10D Stability Scaled Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Return Momentum

Use this Skill to compute `10日稳定度缩放收益动量` / `10D Stability Scaled Return Momentum` from caller-provided OHLCV data.
