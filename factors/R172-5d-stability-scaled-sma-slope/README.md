...
`5日稳定度缩放均线斜率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `趋势` 类。

### 因子逻辑

```text
stability(sma_slope, window=5)
```
...
- 可用行数: `194863`
- 覆盖率: `0.9895`
- 5日 Rank IC 均值: `0.015715`
- 5日 ICIR: `0.5433`
- 五分组 Q5-Q1 均值: `0.001731`
- Top 组换手: `0.2355`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Stability Scaled SMA Slope` is a real-data-validated framework-neutral OHLCV factor Skill in the `Trend` family.
...
- Usable rows: `194863`
- Coverage: `0.9895`
- 5-day Rank IC mean: `0.015715`
- 5-day ICIR: `0.5433`
- Quintile Q5-Q1 mean: `0.001731`
- Top-quintile turnover: `0.2355`
