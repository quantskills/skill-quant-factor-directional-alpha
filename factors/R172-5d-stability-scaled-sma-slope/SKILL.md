---
name: quant-real-factor-5d-stability-scaled-sma-slope
description: Use when computing the 5D Stability Scaled SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled SMA Slope

Use this Skill to compute `5日稳定度缩放均线斜率` / `5D Stability Scaled SMA Slope` from caller-provided OHLCV data.
