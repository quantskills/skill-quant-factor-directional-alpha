---
name: quant-real-factor-5d-volume-confirmed-lower-breakdown
description: Use when computing the 5D Volume Confirmed Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Lower Breakdown

Use this Skill to compute `5日量能确认下轨跌破` / `5D Volume Confirmed Lower Breakdown` from caller-provided OHLCV data.
