---
name: quant-real-factor-5d-volume-confirmed-skip-period-momentum
description: Use when computing the 5D Volume Confirmed Skip-Period Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Skip-Period Momentum

Use this Skill to compute `5日量能确认跳期收益动量` / `5D Volume Confirmed Skip-Period Momentum` from caller-provided OHLCV data.
