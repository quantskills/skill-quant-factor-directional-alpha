---
name: quant-real-factor-7d-smoothed-lower-breakdown
description: Use when computing the 7D Smoothed Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Lower Breakdown

Use this Skill to compute `7日平滑下轨跌破` / `7D Smoothed Lower Breakdown` from caller-provided OHLCV data.
