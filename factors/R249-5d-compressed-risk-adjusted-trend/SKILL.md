---
name: quant-real-factor-5d-compressed-risk-adjusted-trend
description: Use when computing the 5D Compressed Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Risk-Adjusted Trend

Use this Skill to compute `5日压缩风险调整趋势` / `5D Compressed Risk-Adjusted Trend` from caller-provided OHLCV data.
