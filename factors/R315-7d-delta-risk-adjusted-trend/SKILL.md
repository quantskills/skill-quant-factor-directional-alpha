---
name: quant-real-factor-7d-delta-risk-adjusted-trend
description: Use when computing the 7D Delta Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Risk-Adjusted Trend

Use this Skill to compute `7日变化风险调整趋势` / `7D Delta Risk-Adjusted Trend` from caller-provided OHLCV data.
