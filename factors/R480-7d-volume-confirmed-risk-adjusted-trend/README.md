...
`7日量能确认风险调整趋势` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `趋势` 类。

### 因子逻辑

```text
confirm_volume(trend_strength, window=7)
```
...
`7D Volume Confirmed Risk-Adjusted Trend` is a real-data-validated framework-neutral OHLCV factor Skill in the `Trend` family.
...
- Usable rows: `195149`
- Coverage: `0.9909`
- 5-day Rank IC mean: `0.010911`
- 5-day ICIR: `0.3799`
- Quintile Q5-Q1 mean: `0.001955`
- Top-quintile turnover: `0.3571`
