---
name: quant-real-factor-10d-compressed-sma-slope
description: Use when computing the 10D Compressed SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed SMA Slope

Use this Skill to compute `10日压缩均线斜率` / `10D Compressed SMA Slope` from caller-provided OHLCV data.
