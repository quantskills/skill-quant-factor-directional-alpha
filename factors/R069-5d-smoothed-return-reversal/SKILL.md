---
name: quant-real-factor-5d-smoothed-return-reversal
description: Use when computing the 5D Smoothed Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Return Reversal

Use this Skill to compute `5日平滑收益反转` / `5D Smoothed Return Reversal` from caller-provided OHLCV data.
