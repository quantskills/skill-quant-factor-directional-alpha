...
`7日变化上轨突破` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `突破` 类。

### 因子逻辑

```text
delta(breakout, window=7)
```
...
`7D Delta Upper Breakout` is a real-data-validated framework-neutral OHLCV factor Skill in the `Breakout` family.
...
- Usable rows: `195603`
- Coverage: `0.9932`
- 5-day Rank IC mean: `-0.010642`
- 5-day ICIR: `-0.3682`
- Quintile Q5-Q1 mean: `-0.000767`
- Top-quintile turnover: `0.7887`
