---
name: quant-real-factor-7d-delta-upper-breakout
description: Use when computing the 7D Delta Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Upper Breakout

Use this Skill to compute `7日变化上轨突破` / `7D Delta Upper Breakout` from caller-provided OHLCV data.
