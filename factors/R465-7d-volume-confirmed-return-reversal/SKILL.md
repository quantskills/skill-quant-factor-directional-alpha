---
name: quant-real-factor-7d-volume-confirmed-return-reversal
description: Use when computing the 7D Volume Confirmed Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Return Reversal

Use this Skill to compute `7日量能确认收益反转` / `7D Volume Confirmed Return Reversal` from caller-provided OHLCV data.
