---
name: quant-real-factor-7d-smoothed-risk-adjusted-trend
description: Use when computing the 7D Smoothed Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Risk-Adjusted Trend

Use this Skill to compute `7日平滑风险调整趋势` / `7D Smoothed Risk-Adjusted Trend` from caller-provided OHLCV data.
