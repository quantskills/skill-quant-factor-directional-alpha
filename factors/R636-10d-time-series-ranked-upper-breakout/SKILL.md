---
name: quant-real-factor-10d-time-series-ranked-upper-breakout
description: Use when computing the 10D Time-Series Ranked Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Upper Breakout

Use this Skill to compute `10日时序排名上轨突破` / `10D Time-Series Ranked Upper Breakout` from caller-provided OHLCV data.
