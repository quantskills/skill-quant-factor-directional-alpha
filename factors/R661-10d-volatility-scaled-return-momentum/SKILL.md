---
name: quant-real-factor-10d-volatility-scaled-return-momentum
description: Use when computing the 10D Volatility Scaled Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Return Momentum

Use this Skill to compute `10日波动缩放收益动量` / `10D Volatility Scaled Return Momentum` from caller-provided OHLCV data.
