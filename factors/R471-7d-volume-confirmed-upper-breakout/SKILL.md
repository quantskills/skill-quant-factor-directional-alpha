---
name: quant-real-factor-7d-volume-confirmed-upper-breakout
description: Use when computing the 7D Volume Confirmed Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Upper Breakout

Use this Skill to compute `7日量能确认上轨突破` / `7D Volume Confirmed Upper Breakout` from caller-provided OHLCV data.
