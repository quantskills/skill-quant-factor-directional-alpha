---
name: quant-real-factor-5d-volatility-scaled-trend-efficiency
description: Use when computing the 5D Volatility Scaled Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Trend Efficiency

Use this Skill to compute `5日波动缩放趋势效率` / `5D Volatility Scaled Trend Efficiency` from caller-provided OHLCV data.
