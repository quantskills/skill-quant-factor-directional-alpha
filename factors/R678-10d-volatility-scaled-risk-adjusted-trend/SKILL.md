---
name: quant-real-factor-10d-volatility-scaled-risk-adjusted-trend
description: Use when computing the 10D Volatility Scaled Risk-Adjusted Trend factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Risk-Adjusted Trend

Use this Skill to compute `10日波动缩放风险调整趋势` / `10D Volatility Scaled Risk-Adjusted Trend` from caller-provided OHLCV data.
