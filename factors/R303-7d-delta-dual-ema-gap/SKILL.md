---
name: quant-real-factor-7d-delta-dual-ema-gap
description: Use when computing the 7D Delta Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Dual EMA Gap

Use this Skill to compute `7日变化双EMA趋势差` / `7D Delta Dual EMA Gap` from caller-provided OHLCV data.
