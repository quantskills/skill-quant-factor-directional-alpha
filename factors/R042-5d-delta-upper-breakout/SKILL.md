---
name: quant-real-factor-5d-delta-upper-breakout
description: Use when computing the 5D Delta Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Upper Breakout

Use this Skill to compute `5日变化上轨突破` / `5D Delta Upper Breakout` from caller-provided OHLCV data.
