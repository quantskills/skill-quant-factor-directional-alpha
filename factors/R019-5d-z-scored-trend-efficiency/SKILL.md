---
name: quant-real-factor-5d-z-scored-trend-efficiency
description: Use when computing the 5D Z-Scored Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Trend Efficiency

Use this Skill to compute `5日标准化趋势效率` / `5D Z-Scored Trend Efficiency` from caller-provided OHLCV data.
