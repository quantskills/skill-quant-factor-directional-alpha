---
name: quant-real-factor-10d-smoothed-risk-adjusted-trend
description: Use when computing the 10D Smoothed Risk-Adjusted Trend factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Risk-Adjusted Trend

Use this Skill to compute `10日平滑风险调整趋势` / `10D Smoothed Risk-Adjusted Trend` from caller-provided OHLCV data.
