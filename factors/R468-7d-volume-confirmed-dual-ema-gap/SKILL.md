---
name: quant-real-factor-7d-volume-confirmed-dual-ema-gap
description: Use when computing the 7D Volume Confirmed Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Dual EMA Gap

Use this Skill to compute `7日量能确认双EMA趋势差` / `7D Volume Confirmed Dual EMA Gap` from caller-provided OHLCV data.
