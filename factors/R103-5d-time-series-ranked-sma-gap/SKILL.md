---
name: quant-real-factor-5d-time-series-ranked-sma-gap
description: Use when computing the 5D Time-Series Ranked SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Time-Series Ranked SMA Gap

Use this Skill to compute `5日时序排名均线偏离` / `5D Time-Series Ranked SMA Gap` from caller-provided OHLCV data.
