---
name: quant-real-factor-10d-delta-lower-breakdown
description: Use when computing the 10D Delta Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Lower Breakdown

Use this Skill to compute `10日变化下轨跌破` / `10D Delta Lower Breakdown` from caller-provided OHLCV data.
