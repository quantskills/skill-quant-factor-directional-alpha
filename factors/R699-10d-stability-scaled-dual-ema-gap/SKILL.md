---
name: quant-real-factor-10d-stability-scaled-dual-ema-gap
description: Use when computing the 10D Stability Scaled Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Dual EMA Gap

Use this Skill to compute `10日稳定度缩放双EMA趋势差` / `10D Stability Scaled Dual EMA Gap` from caller-provided OHLCV data.
