---
name: quant-real-factor-10d-smoothed-return-reversal
description: Use when computing the 10D Smoothed Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Return Reversal

Use this Skill to compute `10日平滑收益反转` / `10D Smoothed Return Reversal` from caller-provided OHLCV data.
