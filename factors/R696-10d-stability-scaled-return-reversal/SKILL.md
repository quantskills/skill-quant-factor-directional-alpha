---
name: quant-real-factor-10d-stability-scaled-return-reversal
description: Use when computing the 10D Stability Scaled Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Return Reversal

Use this Skill to compute `10日稳定度缩放收益反转` / `10D Stability Scaled Return Reversal` from caller-provided OHLCV data.
