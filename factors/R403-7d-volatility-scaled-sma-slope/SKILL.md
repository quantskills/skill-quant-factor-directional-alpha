---
name: quant-real-factor-7d-volatility-scaled-sma-slope
description: Use when computing the 7D Volatility Scaled SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled SMA Slope

Use this Skill to compute `7日波动缩放均线斜率` / `7D Volatility Scaled SMA Slope` from caller-provided OHLCV data.
