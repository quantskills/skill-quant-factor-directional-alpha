---
name: quant-real-factor-7d-smoothed-dual-ema-gap
description: Use when computing the 7D Smoothed Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Dual EMA Gap

Use this Skill to compute `7日平滑双EMA趋势差` / `7D Smoothed Dual EMA Gap` from caller-provided OHLCV data.
