---
name: quant-real-factor-10d-stability-scaled-range-position
description: Use when computing the 10D Stability Scaled Range Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Range Position

Use this Skill to compute `10日稳定度缩放区间位置` / `10D Stability Scaled Range Position` from caller-provided OHLCV data.
