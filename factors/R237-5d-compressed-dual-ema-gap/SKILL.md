---
name: quant-real-factor-5d-compressed-dual-ema-gap
description: Use when computing the 5D Compressed Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Dual EMA Gap

Use this Skill to compute `5日压缩双EMA趋势差` / `5D Compressed Dual EMA Gap` from caller-provided OHLCV data.
