---
name: quant-real-factor-7d-z-scored-return-momentum
description: Use when computing the 7D Z-Scored Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Return Momentum

Use this Skill to compute `7日标准化收益动量` / `7D Z-Scored Return Momentum` from caller-provided OHLCV data.
