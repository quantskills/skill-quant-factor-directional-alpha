---
name: quant-real-factor-5d-smoothed-upper-breakout
description: Use when computing the 5D Smoothed Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Upper Breakout

Use this Skill to compute `5日平滑上轨突破` / `5D Smoothed Upper Breakout` from caller-provided OHLCV data.
