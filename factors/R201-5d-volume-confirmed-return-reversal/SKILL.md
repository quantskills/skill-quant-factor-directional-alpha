---
name: quant-real-factor-5d-volume-confirmed-return-reversal
description: Use when computing the 5D Volume Confirmed Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Return Reversal

Use this Skill to compute `5日量能确认收益反转` / `5D Volume Confirmed Return Reversal` from caller-provided OHLCV data.
