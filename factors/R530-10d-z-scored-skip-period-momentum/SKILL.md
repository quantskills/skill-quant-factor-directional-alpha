---
name: quant-real-factor-10d-z-scored-skip-period-momentum
description: Use when computing the 10D Z-Scored Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Skip-Period Momentum

Use this Skill to compute `10日标准化跳期收益动量` / `10D Z-Scored Skip-Period Momentum` from caller-provided OHLCV data.
