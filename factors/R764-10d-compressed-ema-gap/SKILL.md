---
name: quant-real-factor-10d-compressed-ema-gap
description: Use when computing the 10D Compressed EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed EMA Gap

Use this Skill to compute `10日压缩EMA偏离` / `10D Compressed EMA Gap` from caller-provided OHLCV data.
