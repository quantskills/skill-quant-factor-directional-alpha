---
name: quant-real-factor-5d-volatility-scaled-sma-gap
description: Use when computing the 5D Volatility Scaled SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled SMA Gap

Use this Skill to compute `5日波动缩放均线偏离` / `5D Volatility Scaled SMA Gap` from caller-provided OHLCV data.
