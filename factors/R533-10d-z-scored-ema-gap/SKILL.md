---
name: quant-real-factor-10d-z-scored-ema-gap
description: Use when computing the 10D Z-Scored EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored EMA Gap

Use this Skill to compute `10日标准化EMA偏离` / `10D Z-Scored EMA Gap` from caller-provided OHLCV data.
