---
name: quant-real-factor-7d-smoothed-upper-breakout
description: Use when computing the 7D Smoothed Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Upper Breakout

Use this Skill to compute `7日平滑上轨突破` / `7D Smoothed Upper Breakout` from caller-provided OHLCV data.
