---
name: quant-real-factor-7d-delta-range-position
description: Use when computing the 7D Delta Range Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Range Position

Use this Skill to compute `7日变化区间位置` / `7D Delta Range Position` from caller-provided OHLCV data.
