---
name: quant-real-factor-10d-volatility-scaled-dual-ema-gap
description: Use when computing the 10D Volatility Scaled Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Dual EMA Gap

Use this Skill to compute `10日波动缩放双EMA趋势差` / `10D Volatility Scaled Dual EMA Gap` from caller-provided OHLCV data.
