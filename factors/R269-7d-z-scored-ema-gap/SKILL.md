---
name: quant-real-factor-7d-z-scored-ema-gap
description: Use when computing the 7D Z-Scored EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日标准化EMA偏离` / `7D Z-Scored EMA Gap` from caller-provided OHLCV data.
