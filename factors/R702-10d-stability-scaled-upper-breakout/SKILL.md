---
name: quant-real-factor-10d-stability-scaled-upper-breakout
description: Use when computing the 10D Stability Scaled Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Upper Breakout

Use this Skill to compute `10日稳定度缩放上轨突破` / `10D Stability Scaled Upper Breakout` from caller-provided OHLCV data.
