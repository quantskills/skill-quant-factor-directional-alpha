---
name: quant-real-factor-7d-time-series-ranked-dual-ema-gap
description: Use when computing the 7D Time-Series Ranked Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Time-Series Ranked Dual EMA Gap

Use this Skill to compute `7日时序排名双EMA趋势差` / `7D Time-Series Ranked Dual EMA Gap` from caller-provided OHLCV data.
