---
name: quant-real-factor-5d-delta-dual-ema-gap
description: Use when computing the 5D Delta Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Dual EMA Gap

Use this Skill to compute `5日变化双EMA趋势差` / `5D Delta Dual EMA Gap` from caller-provided OHLCV data.
