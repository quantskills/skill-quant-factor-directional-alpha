---
name: quant-real-factor-7d-volatility-scaled-sma-gap
description: Use when computing the 7D Volatility Scaled SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled SMA Gap

Use this Skill to compute `7日波动缩放均线偏离` / `7D Volatility Scaled SMA Gap` from caller-provided OHLCV data.
