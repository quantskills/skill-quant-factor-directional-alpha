---
name: quant-real-factor-5d-volatility-scaled-dual-ema-gap
description: Use when computing the 5D Volatility Scaled Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Dual EMA Gap

Use this Skill to compute `5日波动缩放双EMA趋势差` / `5D Volatility Scaled Dual EMA Gap` from caller-provided OHLCV data.
