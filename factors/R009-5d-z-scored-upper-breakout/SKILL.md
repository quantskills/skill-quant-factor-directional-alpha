---
name: quant-real-factor-5d-z-scored-upper-breakout
description: Use when computing the 5D Z-Scored Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Upper Breakout

Use this Skill to compute `5日标准化上轨突破` / `5D Z-Scored Upper Breakout` from caller-provided OHLCV data.
