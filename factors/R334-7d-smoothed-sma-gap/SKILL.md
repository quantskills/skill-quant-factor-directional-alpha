---
name: quant-real-factor-7d-smoothed-sma-gap
description: Use when computing the 7D Smoothed SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日平滑均线偏离` / `7D Smoothed SMA Gap` from caller-provided OHLCV data.
