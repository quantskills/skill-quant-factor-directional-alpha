---
name: quant-real-factor-10d-compressed-lower-breakdown
description: Use when computing the 10D Compressed Lower Breakdown factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Lower Breakdown

Use this Skill to compute `10日压缩下轨跌破` / `10D Compressed Lower Breakdown` from caller-provided OHLCV data.
