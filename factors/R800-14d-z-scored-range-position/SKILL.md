---
name: quant-real-factor-14d-z-scored-range-position
description: Use when computing the 14D Z-Scored Range Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 14D Z-Scored Range Position

Use this Skill to compute `14日标准化区间位置` / `14D Z-Scored Range Position` from caller-provided OHLCV data.
