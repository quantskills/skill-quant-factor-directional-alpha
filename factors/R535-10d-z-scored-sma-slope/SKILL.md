---
name: quant-real-factor-10d-z-scored-sma-slope
description: Use when computing the 10D Z-Scored SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored SMA Slope

Use this Skill to compute `10日标准化均线斜率` / `10D Z-Scored SMA Slope` from caller-provided OHLCV data.
