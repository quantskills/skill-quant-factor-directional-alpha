---
name: quant-real-factor-7d-volume-confirmed-sma-gap
description: Use when computing the 7D Volume Confirmed SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed SMA Gap

Use this Skill to compute `7日量能确认均线偏离` / `7D Volume Confirmed SMA Gap` from caller-provided OHLCV data.
