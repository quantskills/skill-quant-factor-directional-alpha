---
name: quant-real-factor-10d-z-scored-range-position
description: Use when computing the 10D Z-Scored Range Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Range Position

Use this Skill to compute `10日标准化区间位置` / `10D Z-Scored Range Position` from caller-provided OHLCV data.
