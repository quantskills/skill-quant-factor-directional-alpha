---
name: quant-real-factor-10d-smoothed-skip-period-momentum
description: Use when computing the 10D Smoothed Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Skip-Period Momentum

Use this Skill to compute `10日平滑跳期收益动量` / `10D Smoothed Skip-Period Momentum` from caller-provided OHLCV data.
