---
name: quant-real-factor-10d-time-series-ranked-sma-slope
description: Use when computing the 10D Time-Series Ranked SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked SMA Slope

Use this Skill to compute `10日时序排名均线斜率` / `10D Time-Series Ranked SMA Slope` from caller-provided OHLCV data.
