---
name: quant-real-factor-5d-z-scored-ema-gap
description: Use when computing the 5D Z-Scored EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日标准化EMA偏离` / `5D Z-Scored EMA Gap` from caller-provided OHLCV data.
