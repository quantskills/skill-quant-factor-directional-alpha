---
name: quant-real-factor-10d-stability-scaled-skip-period-momentum
description: Use when computing the 10D Stability Scaled Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Skip-Period Momentum

Use this Skill to compute `10日稳定度缩放跳期收益动量` / `10D Stability Scaled Skip-Period Momentum` from caller-provided OHLCV data.
