---
name: quant-real-factor-14d-z-scored-ema-gap
description: Use when computing the 14D Z-Scored EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 14D Z-Scored EMA Gap

Use this Skill to compute `14日标准化EMA偏离` / `14D Z-Scored EMA Gap` from caller-provided OHLCV data.
