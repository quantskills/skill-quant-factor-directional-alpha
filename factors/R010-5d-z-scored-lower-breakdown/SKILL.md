---
name: quant-real-factor-5d-z-scored-lower-breakdown
description: Use when computing the 5D Z-Scored Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Lower Breakdown

Use this Skill to compute `5日标准化下轨跌破` / `5D Z-Scored Lower Breakdown` from caller-provided OHLCV data.
