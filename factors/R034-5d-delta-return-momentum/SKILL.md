---
name: quant-real-factor-5d-delta-return-momentum
description: Use when computing the 5D Delta Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Return Momentum

Use this Skill to compute `5日变化收益动量` / `5D Delta Return Momentum` from caller-provided OHLCV data.
