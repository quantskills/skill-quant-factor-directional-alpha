---
name: quant-real-factor-7d-stability-scaled-sma-gap
description: Use when computing the 7D Stability Scaled SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled SMA Gap

Use this Skill to compute `7日稳定度缩放均线偏离` / `7D Stability Scaled SMA Gap` from caller-provided OHLCV data.
