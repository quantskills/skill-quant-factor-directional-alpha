---
name: quant-real-factor-5d-time-series-ranked-trend-efficiency
description: Use when computing the 5D Time-Series Ranked Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Time-Series Ranked Trend Efficiency

Use this Skill to compute `5日时序排名趋势效率` / `5D Time-Series Ranked Trend Efficiency` from caller-provided OHLCV data.
