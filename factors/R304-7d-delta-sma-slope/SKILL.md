---
name: quant-real-factor-7d-delta-sma-slope
description: Use when computing the 7D Delta SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化均线斜率` / `7D Delta SMA Slope` from caller-provided OHLCV data.
