---
name: quant-real-factor-7d-stability-scaled-dual-ema-gap
description: Use when computing the 7D Stability Scaled Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Dual EMA Gap

Use this Skill to compute `7日稳定度缩放双EMA趋势差` / `7D Stability Scaled Dual EMA Gap` from caller-provided OHLCV data.
