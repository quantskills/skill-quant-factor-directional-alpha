---
name: quant-real-factor-5d-smoothed-sma-slope
description: Use when computing the 5D Smoothed SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed SMA Slope

Use this Skill to compute `5日平滑均线斜率` / `5D Smoothed SMA Slope` from caller-provided OHLCV data.
