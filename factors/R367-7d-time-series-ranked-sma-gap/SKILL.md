---
name: quant-real-factor-7d-time-series-ranked-sma-gap
description: Use when computing the 7D Time-Series Ranked SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Time-Series Ranked SMA Gap

Use this Skill to compute `7日时序排名均线偏离` / `7D Time-Series Ranked SMA Gap` from caller-provided OHLCV data.
