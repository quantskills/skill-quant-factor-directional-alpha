---
name: quant-real-factor-5d-compressed-upper-breakout
description: Use when computing the 5D Compressed Upper Breakout factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Upper Breakout

Use this Skill to compute `5日压缩上轨突破` / `5D Compressed Upper Breakout` from caller-provided OHLCV data.
