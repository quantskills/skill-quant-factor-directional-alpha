---
name: quant-real-factor-10d-z-scored-dual-ema-gap
description: Use when computing the 10D Z-Scored Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Dual EMA Gap

Use this Skill to compute `10日标准化双EMA趋势差` / `10D Z-Scored Dual EMA Gap` from caller-provided OHLCV data.
