---
name: quant-real-factor-7d-compressed-sma-gap
description: Use when computing the 7D Compressed SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed SMA Gap

Use this Skill to compute `7日压缩均线偏离` / `7D Compressed SMA Gap` from caller-provided OHLCV data.
