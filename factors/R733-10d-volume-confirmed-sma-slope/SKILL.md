---
name: quant-real-factor-10d-volume-confirmed-sma-slope
description: Use when computing the 10D Volume Confirmed SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed SMA Slope

Use this Skill to compute `10日量能确认均线斜率` / `10D Volume Confirmed SMA Slope` from caller-provided OHLCV data.
