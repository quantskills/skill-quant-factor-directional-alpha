---
name: quant-real-factor-5d-compressed-ema-gap
description: Use when computing the 5D Compressed EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed EMA Gap

Use this Skill to compute `5日压缩EMA偏离` / `5D Compressed EMA Gap` from caller-provided OHLCV data.
