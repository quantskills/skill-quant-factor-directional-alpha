---
name: quant-real-factor-7d-volume-confirmed-ema-gap
description: Use when computing the 7D Volume Confirmed EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed EMA Gap

Use this Skill to compute `7日量能确认EMA偏离` / `7D Volume Confirmed EMA Gap` from caller-provided OHLCV data.
