---
name: quant-real-factor-10d-time-series-ranked-return-reversal
description: Use when computing the 10D Time-Series Ranked Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Return Reversal

Use this Skill to compute `10日时序排名收益反转` / `10D Time-Series Ranked Return Reversal` from caller-provided OHLCV data.
