---
name: quant-real-factor-7d-delta-return-momentum
description: Use when computing the 7D Delta Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Return Momentum

Use this Skill to compute `7日变化收益动量` / `7D Delta Return Momentum` from caller-provided OHLCV data.
