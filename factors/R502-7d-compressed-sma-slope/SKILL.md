---
name: quant-real-factor-7d-compressed-sma-slope
description: Use when computing the 7D Compressed SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed SMA Slope

Use this Skill to compute `7日压缩均线斜率` / `7D Compressed SMA Slope` from caller-provided OHLCV data.
