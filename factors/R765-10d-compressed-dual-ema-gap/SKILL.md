---
name: quant-real-factor-10d-compressed-dual-ema-gap
description: Use when computing the 10D Compressed Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Dual EMA Gap

Use this Skill to compute `10日压缩双EMA趋势差` / `10D Compressed Dual EMA Gap` from caller-provided OHLCV data.
