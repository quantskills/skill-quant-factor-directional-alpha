...
`5日稳定度缩放风险调整趋势` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `趋势` 类。

### 因子逻辑

```text
stability(trend_strength, window=5)
```
...
`5D Stability Scaled Risk-Adjusted Trend` is a real-data-validated framework-neutral OHLCV factor Skill in the `Trend` family.
...
- Usable rows: `194834`
- Coverage: `0.9893`
- 5-day Rank IC mean: `0.008296`
- 5-day ICIR: `0.2958`
- Quintile Q5-Q1 mean: `0.001141`
- Top-quintile turnover: `0.3990`
