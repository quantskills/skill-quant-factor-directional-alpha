---
name: quant-real-factor-5d-delta-sma-slope
description: Use when computing the 5D Delta SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日变化均线斜率` / `5D Delta SMA Slope` from caller-provided OHLCV data.
