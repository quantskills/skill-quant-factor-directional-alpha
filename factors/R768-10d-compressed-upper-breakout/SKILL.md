---
name: quant-real-factor-10d-compressed-upper-breakout
description: Use when computing the 10D Compressed Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Upper Breakout

Use this Skill to compute `10日压缩上轨突破` / `10D Compressed Upper Breakout` from caller-provided OHLCV data.
