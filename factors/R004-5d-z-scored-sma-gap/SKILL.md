---
name: quant-real-factor-5d-z-scored-sma-gap
description: Use when computing the 5D Z-Scored SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日标准化均线偏离` / `5D Z-Scored SMA Gap` from caller-provided OHLCV data.
