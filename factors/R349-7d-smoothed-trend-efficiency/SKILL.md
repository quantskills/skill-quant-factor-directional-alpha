---
name: quant-real-factor-7d-smoothed-trend-efficiency
description: Use when computing the 7D Smoothed Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Trend Efficiency

Use this Skill to compute `7日平滑趋势效率` / `7D Smoothed Trend Efficiency` from caller-provided OHLCV data.
