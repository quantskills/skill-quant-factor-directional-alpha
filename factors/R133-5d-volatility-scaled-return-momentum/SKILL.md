---
name: quant-real-factor-5d-volatility-scaled-return-momentum
description: Use when computing the 5D Volatility Scaled Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
