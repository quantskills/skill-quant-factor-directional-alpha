---
name: quant-real-factor-10d-volume-confirmed-return-reversal
description: Use when computing the 10D Volume Confirmed Return Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Return Reversal

Use this Skill to compute `10日量能确认收益反转` / `10D Volume Confirmed Return Reversal` from caller-provided OHLCV data.
