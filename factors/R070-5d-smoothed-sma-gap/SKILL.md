---
name: quant-real-factor-5d-smoothed-sma-gap
description: Use when computing the 5D Smoothed SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日平滑均线偏离` / `5D Smoothed SMA Gap` from caller-provided OHLCV data.
