---
name: quant-real-factor-10d-stability-scaled-sma-slope
description: Use when computing the 10D Stability Scaled SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled SMA Slope

Use this Skill to compute `10日稳定度缩放均线斜率` / `10D Stability Scaled SMA Slope` from caller-provided OHLCV data.
