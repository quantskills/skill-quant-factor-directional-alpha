---
name: quant-real-factor-7d-compressed-skip-period-momentum
description: Use when computing the 7D Compressed Skip-Period Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Skip-Period Momentum

Use this Skill to compute `7日压缩跳期收益动量` / `7D Compressed Skip-Period Momentum` from caller-provided OHLCV data.
