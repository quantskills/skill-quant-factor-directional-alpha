---
name: quant-real-factor-7d-z-scored-return-reversal
description: Use when computing the 7D Z-Scored Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Return Reversal

Use this Skill to compute `7日标准化收益反转` / `7D Z-Scored Return Reversal` from caller-provided OHLCV data.
