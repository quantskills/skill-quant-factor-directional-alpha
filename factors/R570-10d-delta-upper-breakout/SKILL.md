---
name: quant-real-factor-10d-delta-upper-breakout
description: Use when computing the 10D Delta Upper Breakout factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Upper Breakout

Use this Skill to compute `10日变化上轨突破` / `10D Delta Upper Breakout` from caller-provided OHLCV data.
