---
name: quant-real-factor-5d-delta-sma-gap
description: Use when computing the 5D Delta SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日变化均线偏离` / `5D Delta SMA Gap` from caller-provided OHLCV data.
