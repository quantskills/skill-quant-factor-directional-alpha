---
name: quant-real-factor-10d-z-scored-return-momentum
description: Use when computing the 10D Z-Scored Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Return Momentum

Use this Skill to compute `10日标准化收益动量` / `10D Z-Scored Return Momentum` from caller-provided OHLCV data.
