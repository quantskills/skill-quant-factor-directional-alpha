---
name: quant-real-factor-5d-compressed-return-reversal
description: Use when computing the 5D Compressed Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Return Reversal

Use this Skill to compute `5日压缩收益反转` / `5D Compressed Return Reversal` from caller-provided OHLCV data.
