---
name: quant-real-factor-7d-stability-scaled-return-reversal
description: Use when computing the 7D Stability Scaled Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Return Reversal

Use this Skill to compute `7日稳定度缩放收益反转` / `7D Stability Scaled Return Reversal` from caller-provided OHLCV data.
