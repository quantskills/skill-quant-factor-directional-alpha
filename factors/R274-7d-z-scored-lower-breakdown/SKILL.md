---
name: quant-real-factor-7d-z-scored-lower-breakdown
description: Use when computing the 7D Z-Scored Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Lower Breakdown

Use this Skill to compute `7日标准化下轨跌破` / `7D Z-Scored Lower Breakdown` from caller-provided OHLCV data.
