---
name: quant-real-factor-7d-smoothed-ema-gap
description: Use when computing the 7D Smoothed EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日平滑EMA偏离` / `7D Smoothed EMA Gap` from caller-provided OHLCV data.
