---
name: quant-real-factor-10d-delta-sma-gap
description: Use when computing the 10D Delta SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日变化均线偏离` / `10D Delta SMA Gap` from caller-provided OHLCV data.
