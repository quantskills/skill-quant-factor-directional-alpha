---
name: quant-real-factor-7d-compressed-dual-ema-gap
description: Use when computing the 7D Compressed Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Dual EMA Gap

Use this Skill to compute `7日压缩双EMA趋势差` / `7D Compressed Dual EMA Gap` from caller-provided OHLCV data.
