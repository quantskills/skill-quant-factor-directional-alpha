---
name: quant-real-factor-5d-stability-scaled-lower-breakdown
description: Use when computing the 5D Stability Scaled Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Lower Breakdown

Use this Skill to compute `5日稳定度缩放下轨跌破` / `5D Stability Scaled Lower Breakdown` from caller-provided OHLCV data.
