---
name: quant-real-factor-10d-smoothed-return-momentum
description: Use when computing the 10D Smoothed Return Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Return Momentum

Use this Skill to compute `10日平滑收益动量` / `10D Smoothed Return Momentum` from caller-provided OHLCV data.
