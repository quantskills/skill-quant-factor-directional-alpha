---
name: quant-real-factor-10d-compressed-risk-adjusted-trend
description: Use when computing the 10D Compressed Risk-Adjusted Trend factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Risk-Adjusted Trend

Use this Skill to compute `10日压缩风险调整趋势` / `10D Compressed Risk-Adjusted Trend` from caller-provided OHLCV data.
