...
`5日时序排名收益反转` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `反转` 类。

### 因子逻辑

```text
rank(reversal, window=5)
```
...
- 可用行数: `194863`
- 覆盖率: `0.9895`
- 5日 Rank IC 均值: `0.000771`
- 5日 ICIR: `0.0277`
- 五分组 Q5-Q1 均值: `0.000284`
- Top 组换手: `0.4271`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Time-Series Ranked Return Reversal` is a real-data-validated framework-neutral OHLCV factor Skill in the `Reversal` family.
...
- Usable rows: `194863`
- Coverage: `0.9895`
- 5-day Rank IC mean: `0.000771`
- 5-day ICIR: `0.0277`
- Quintile Q5-Q1 mean: `0.000284`
- Top-quintile turnover: `0.4271`
