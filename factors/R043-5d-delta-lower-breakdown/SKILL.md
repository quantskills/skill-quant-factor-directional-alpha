---
name: quant-real-factor-5d-delta-lower-breakdown
description: Use when computing the 5D Delta Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Lower Breakdown

Use this Skill to compute `5日变化下轨跌破` / `5D Delta Lower Breakdown` from caller-provided OHLCV data.
