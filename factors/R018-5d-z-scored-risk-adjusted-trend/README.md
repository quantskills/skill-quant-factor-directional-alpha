...
`5日标准化风险调整趋势` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `趋势` 类。

### 因子逻辑

```text
z(trend_strength, window=5)
```
...
- 可用行数: `194834`
- 覆盖率: `0.9893`
- 5日 Rank IC 均值: `-0.001190`
- 5日 ICIR: `-0.0433`
- 五分组 Q5-Q1 均值: `0.000024`
- Top 组换手: `0.4126`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Z-Scored Risk-Adjusted Trend` is a real-data-validated framework-neutral OHLCV factor Skill in the `Trend` family.
...
- Usable rows: `194834`
- Coverage: `0.9893`
- 5-day Rank IC mean: `-0.001190`
- 5-day ICIR: `-0.0433`
- Quintile Q5-Q1 mean: `0.000024`
- Top-quintile turnover: `0.4126`
