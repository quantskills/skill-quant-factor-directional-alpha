---
name: quant-real-factor-10d-delta-risk-adjusted-trend
description: Use when computing the 10D Delta Risk-Adjusted Trend factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Risk-Adjusted Trend

Use this Skill to compute `10日变化风险调整趋势` / `10D Delta Risk-Adjusted Trend` from caller-provided OHLCV data.
