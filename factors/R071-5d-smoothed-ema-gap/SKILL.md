---
name: quant-real-factor-5d-smoothed-ema-gap
description: Use when computing the 5D Smoothed EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日平滑EMA偏离` / `5D Smoothed EMA Gap` from caller-provided OHLCV data.
