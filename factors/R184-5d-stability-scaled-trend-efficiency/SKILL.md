---
name: quant-real-factor-5d-stability-scaled-trend-efficiency
description: Use when computing the 5D Stability Scaled Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Trend Efficiency

Use this Skill to compute `5日稳定度缩放趋势效率` / `5D Stability Scaled Trend Efficiency` from caller-provided OHLCV data.
