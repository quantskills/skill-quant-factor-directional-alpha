---
name: quant-real-factor-7d-volume-confirmed-return-momentum
description: Use when computing the 7D Volume Confirmed Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Return Momentum

Use this Skill to compute `7日量能确认收益动量` / `7D Volume Confirmed Return Momentum` from caller-provided OHLCV data.
