---
name: quant-real-factor-5d-stability-scaled-risk-adjusted-trend
description: Use when computing the 5D Stability Scaled Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Risk-Adjusted Trend

Use this Skill to compute `5日稳定度缩放风险调整趋势` / `5D Stability Scaled Risk-Adjusted Trend` from caller-provided OHLCV data.
