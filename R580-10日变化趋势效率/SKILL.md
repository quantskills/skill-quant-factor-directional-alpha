---
name: quant-real-factor-10d-delta-trend-efficiency
description: Use when computing the 10D Delta Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Trend Efficiency

Use this Skill to compute `10日变化趋势效率` / `10D Delta Trend Efficiency` from caller-provided OHLCV data.
