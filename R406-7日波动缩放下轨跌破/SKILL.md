---
name: quant-real-factor-7d-volatility-scaled-lower-breakdown
description: Use when computing the 7D Volatility Scaled Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled Lower Breakdown

Use this Skill to compute `7日波动缩放下轨跌破` / `7D Volatility Scaled Lower Breakdown` from caller-provided OHLCV data.
