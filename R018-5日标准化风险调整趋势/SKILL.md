---
name: quant-real-factor-5d-z-scored-risk-adjusted-trend
description: Use when computing the 5D Z-Scored Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Risk-Adjusted Trend

Use this Skill to compute `5日标准化风险调整趋势` / `5D Z-Scored Risk-Adjusted Trend` from caller-provided OHLCV data.
