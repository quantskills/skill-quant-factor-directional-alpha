---
name: quant-real-factor-10d-smoothed-ema-gap
description: Use when computing the 10D Smoothed EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
