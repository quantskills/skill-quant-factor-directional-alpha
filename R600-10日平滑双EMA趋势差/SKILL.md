---
name: quant-real-factor-10d-smoothed-dual-ema-gap
description: Use when computing the 10D Smoothed Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Dual EMA Gap

Use this Skill to compute `10日平滑双EMA趋势差` / `10D Smoothed Dual EMA Gap` from caller-provided OHLCV data.
