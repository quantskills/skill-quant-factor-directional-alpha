...
```mermaid
flowchart LR
    D["🧭 directional-alpha<br/>directional (this repo)<br/>trend · momentum · reversal · breakout · channel"] ~~~ R["🛡️ risk-pattern-alpha<br/>risk & pattern<br/>volatility · candles · oscillator · drawdown"] ~~~ V["📊 volume-stat-alpha<br/>volume & statistics<br/>volume · price-volume · liquidity · ts-rank · distribution"]
...
```mermaid
flowchart LR
    A["📂 Enter any factor directory<br/>factors/R001-.../"] --> B["🧪 validate.py self-check<br/>validation_real/result.json + report.md"]
