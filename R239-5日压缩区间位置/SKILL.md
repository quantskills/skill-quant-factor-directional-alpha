---
name: quant-real-factor-5d-compressed-range-position
description: Use when computing the 5D Compressed Range Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Range Position

Use this Skill to compute `5日压缩区间位置` / `5D Compressed Range Position` from caller-provided OHLCV data.
