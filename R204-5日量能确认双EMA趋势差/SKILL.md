---
name: quant-real-factor-5d-volume-confirmed-dual-ema-gap
description: Use when computing the 5D Volume Confirmed Dual EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Dual EMA Gap

Use this Skill to compute `5日量能确认双EMA趋势差` / `5D Volume Confirmed Dual EMA Gap` from caller-provided OHLCV data.
