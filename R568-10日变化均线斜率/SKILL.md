---
name: quant-real-factor-10d-delta-sma-slope
description: Use when computing the 10D Delta SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日变化均线斜率` / `10D Delta SMA Slope` from caller-provided OHLCV data.
