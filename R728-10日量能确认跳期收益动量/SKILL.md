---
name: quant-real-factor-10d-volume-confirmed-skip-period-momentum
description: Use when computing the 10D Volume Confirmed Skip-Period Momentum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Skip-Period Momentum

Use this Skill to compute `10日量能确认跳期收益动量` / `10D Volume Confirmed Skip-Period Momentum` from caller-provided OHLCV data.
