---
name: quant-real-factor-10d-delta-ema-gap
description: Use when computing the 10D Delta EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日变化EMA偏离` / `10D Delta EMA Gap` from caller-provided OHLCV data.
