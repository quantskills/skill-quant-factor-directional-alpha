---
name: quant-real-factor-5d-stability-scaled-skip-period-momentum
description: Use when computing the 5D Stability Scaled Skip-Period Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Skip-Period Momentum

Use this Skill to compute `5日稳定度缩放跳期收益动量` / `5D Stability Scaled Skip-Period Momentum` from caller-provided OHLCV data.
