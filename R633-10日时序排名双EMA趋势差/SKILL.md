---
name: quant-real-factor-10d-time-series-ranked-dual-ema-gap
description: Use when computing the 10D Time-Series Ranked Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Dual EMA Gap

Use this Skill to compute `10日时序排名双EMA趋势差` / `10D Time-Series Ranked Dual EMA Gap` from caller-provided OHLCV data.
