---
name: quant-real-factor-5d-delta-ema-gap
description: Use when computing the 5D Delta EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日变化EMA偏离` / `5D Delta EMA Gap` from caller-provided OHLCV data.
