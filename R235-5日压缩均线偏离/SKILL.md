---
name: quant-real-factor-5d-compressed-sma-gap
description: Use when computing the 5D Compressed SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed SMA Gap

Use this Skill to compute `5日压缩均线偏离` / `5D Compressed SMA Gap` from caller-provided OHLCV data.
