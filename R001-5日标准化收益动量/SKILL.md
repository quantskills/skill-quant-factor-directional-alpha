---
name: quant-real-factor-5d-z-scored-return-momentum
description: Use when computing the 5D Z-Scored Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Return Momentum

Use this Skill to compute `5日标准化收益动量` / `5D Z-Scored Return Momentum` from caller-provided OHLCV data.
