---
name: quant-real-factor-10d-compressed-trend-efficiency
description: Use when computing the 10D Compressed Trend Efficiency factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Trend Efficiency

Use this Skill to compute `10日压缩趋势效率` / `10D Compressed Trend Efficiency` from caller-provided OHLCV data.
