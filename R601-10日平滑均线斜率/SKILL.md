---
name: quant-real-factor-10d-smoothed-sma-slope
description: Use when computing the 10D Smoothed SMA Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed SMA Slope

Use this Skill to compute `10日平滑均线斜率` / `10D Smoothed SMA Slope` from caller-provided OHLCV data.
