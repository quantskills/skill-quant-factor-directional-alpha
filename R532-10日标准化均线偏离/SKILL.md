---
name: quant-real-factor-10d-z-scored-sma-gap
description: Use when computing the 10D Z-Scored SMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored SMA Gap

Use this Skill to compute `10日标准化均线偏离` / `10D Z-Scored SMA Gap` from caller-provided OHLCV data.
