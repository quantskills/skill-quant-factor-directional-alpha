...
`10日标准化均线偏离` 是一个框架中立的 OHLCV 因子 Skill，属于 `趋势` 类。它只依赖用户传入的行情字段，不绑定任何交易框架或数据供应商。
...
- 市场覆盖: `{"cn": 98, "us": 50}`
- 覆盖率: `0.9902`
- 5日 Rank IC 均值: `0.002731`
- 5日 ICIR: `0.0994`
- 五分组 Q5-Q1 均值: `0.000976`
- Top 组换手: `0.3745`
- 无未来函数检查: `True`
- 状态: `pass`
...
`10D Z-Scored SMA Gap` is a framework-neutral OHLCV factor Skill in the `Trend` family. It depends only on caller-supplied market fields and is not tied to any trading framework or data vendor.
...
- Markets: `{"cn": 98, "us": 50}`
- Coverage: `0.9902`
- 5-day Rank IC mean: `0.002731`
- 5-day ICIR: `0.0994`
- Quintile Q5-Q1 mean: `0.000976`
- Top-quintile turnover: `0.3745`
