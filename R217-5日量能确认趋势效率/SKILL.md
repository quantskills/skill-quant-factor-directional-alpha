---
name: quant-real-factor-5d-volume-confirmed-trend-efficiency
description: Use when computing the 5D Volume Confirmed Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Trend Efficiency

Use this Skill to compute `5日量能确认趋势效率` / `5D Volume Confirmed Trend Efficiency` from caller-provided OHLCV data.
