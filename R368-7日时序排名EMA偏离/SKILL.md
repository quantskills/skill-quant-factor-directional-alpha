---
name: quant-real-factor-7d-time-series-ranked-ema-gap
description: Use when computing the 7D Time-Series Ranked EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Time-Series Ranked EMA Gap

Use this Skill to compute `7日时序排名EMA偏离` / `7D Time-Series Ranked EMA Gap` from caller-provided OHLCV data.
