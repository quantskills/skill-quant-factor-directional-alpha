---
name: quant-real-factor-7d-delta-sma-gap
description: Use when computing the 7D Delta SMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化均线偏离` / `7D Delta SMA Gap` from caller-provided OHLCV data.
