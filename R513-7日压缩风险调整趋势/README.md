...
`7日压缩风险调整趋势` 是一个框架中立的 OHLCV 因子 Skill，属于 `趋势` 类。它只依赖用户传入的行情字段，不绑定任何交易框架或数据供应商。

### 因子逻辑

```text
compress(trend_strength, window=7)
```
...
- 市场覆盖: `{"cn": 98, "us": 50}`
- 覆盖率: `0.9909`
- 5日 Rank IC 均值: `0.013637`
- 5日 ICIR: `0.4729`
- 五分组 Q5-Q1 均值: `0.002138`
- Top 组换手: `0.3341`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Compressed Risk-Adjusted Trend` is a framework-neutral OHLCV factor Skill in the `Trend` family. It depends only on caller-supplied market fields and is not tied to any trading framework or data vendor.
...
- Markets: `{"cn": 98, "us": 50}`
- Coverage: `0.9909`
- 5-day Rank IC mean: `0.013637`
- 5-day ICIR: `0.4729`
- Quintile Q5-Q1 mean: `0.002138`
- Top-quintile turnover: `0.3341`
