---
name: quant-real-factor-7d-smoothed-return-reversal
description: Use when computing the 7D Smoothed Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Return Reversal

Use this Skill to compute `7日平滑收益反转` / `7D Smoothed Return Reversal` from caller-provided OHLCV data.
