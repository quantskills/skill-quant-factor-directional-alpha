---
name: quant-real-factor-7d-smoothed-return-momentum
description: Use when computing the 7D Smoothed Return Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Return Momentum

Use this Skill to compute `7日平滑收益动量` / `7D Smoothed Return Momentum` from caller-provided OHLCV data.
