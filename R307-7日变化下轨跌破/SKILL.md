---
name: quant-real-factor-7d-delta-lower-breakdown
description: Use when computing the 7D Delta Lower Breakdown factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Lower Breakdown

Use this Skill to compute `7日变化下轨跌破` / `7D Delta Lower Breakdown` from caller-provided OHLCV data.
