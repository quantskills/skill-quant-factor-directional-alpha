---
name: quant-real-factor-7d-compressed-return-reversal
description: Use when computing the 7D Compressed Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Return Reversal

Use this Skill to compute `7日压缩收益反转` / `7D Compressed Return Reversal` from caller-provided OHLCV data.
