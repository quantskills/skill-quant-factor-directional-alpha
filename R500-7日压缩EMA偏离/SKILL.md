---
name: quant-real-factor-7d-compressed-ema-gap
description: Use when computing the 7D Compressed EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed EMA Gap

Use this Skill to compute `7日压缩EMA偏离` / `7D Compressed EMA Gap` from caller-provided OHLCV data.
