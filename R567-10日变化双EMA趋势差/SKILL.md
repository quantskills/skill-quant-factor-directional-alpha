---
name: quant-real-factor-10d-delta-dual-ema-gap
description: Use when computing the 10D Delta Dual EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Dual EMA Gap

Use this Skill to compute `10日变化双EMA趋势差` / `10D Delta Dual EMA Gap` from caller-provided OHLCV data.
