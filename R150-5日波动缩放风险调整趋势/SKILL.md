---
name: quant-real-factor-5d-volatility-scaled-risk-adjusted-trend
description: Use when computing the 5D Volatility Scaled Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Risk-Adjusted Trend

Use this Skill to compute `5日波动缩放风险调整趋势` / `5D Volatility Scaled Risk-Adjusted Trend` from caller-provided OHLCV data.
