---
name: quant-real-factor-5d-volume-confirmed-sma-slope
description: Use when computing the 5D Volume Confirmed SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed SMA Slope

Use this Skill to compute `5日量能确认均线斜率` / `5D Volume Confirmed SMA Slope` from caller-provided OHLCV data.
