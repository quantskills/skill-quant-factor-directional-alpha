---
name: quant-real-factor-5d-stability-scaled-ema-gap
description: Use when computing the 5D Stability Scaled EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled EMA Gap

Use this Skill to compute `5日稳定度缩放EMA偏离` / `5D Stability Scaled EMA Gap` from caller-provided OHLCV data.
