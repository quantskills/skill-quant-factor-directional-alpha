---
name: quant-real-factor-7d-stability-scaled-risk-adjusted-trend
description: Use when computing the 7D Stability Scaled Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Risk-Adjusted Trend

Use this Skill to compute `7日稳定度缩放风险调整趋势` / `7D Stability Scaled Risk-Adjusted Trend` from caller-provided OHLCV data.
