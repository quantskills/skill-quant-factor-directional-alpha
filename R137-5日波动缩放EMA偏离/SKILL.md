---
name: quant-real-factor-5d-volatility-scaled-ema-gap
description: Use when computing the 5D Volatility Scaled EMA Gap factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled EMA Gap

Use this Skill to compute `5日波动缩放EMA偏离` / `5D Volatility Scaled EMA Gap` from caller-provided OHLCV data.
