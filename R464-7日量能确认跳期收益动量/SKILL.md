---
name: quant-real-factor-7d-volume-confirmed-skip-period-momentum
description: Use when computing the 7D Volume Confirmed Skip-Period Momentum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Skip-Period Momentum

Use this Skill to compute `7日量能确认跳期收益动量` / `7D Volume Confirmed Skip-Period Momentum` from caller-provided OHLCV data.
