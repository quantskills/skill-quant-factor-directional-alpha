---
name: quant-real-factor-5d-stability-scaled-range-position
description: Use when computing the 5D Stability Scaled Range Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
