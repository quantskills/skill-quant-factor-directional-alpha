---
name: quant-real-factor-10d-volume-confirmed-ema-gap
description: Use when computing the 10D Volume Confirmed EMA Gap factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed EMA Gap

Use this Skill to compute `10日量能确认EMA偏离` / `10D Volume Confirmed EMA Gap` from caller-provided OHLCV data.
