---
name: quant-real-factor-5d-stability-scaled-return-reversal
description: Use when computing the 5D Stability Scaled Return Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Return Reversal

Use this Skill to compute `5日稳定度缩放收益反转` / `5D Stability Scaled Return Reversal` from caller-provided OHLCV data.
