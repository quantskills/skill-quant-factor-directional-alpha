---
name: quant-real-factor-5d-smoothed-trend-efficiency
description: Use when computing the 5D Smoothed Trend Efficiency factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Trend Efficiency

Use this Skill to compute `5日平滑趋势效率` / `5D Smoothed Trend Efficiency` from caller-provided OHLCV data.
