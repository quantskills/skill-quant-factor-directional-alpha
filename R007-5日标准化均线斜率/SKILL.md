---
name: quant-real-factor-5d-z-scored-sma-slope
description: Use when computing the 5D Z-Scored SMA Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored SMA Slope

Use this Skill to compute `5日标准化均线斜率` / `5D Z-Scored SMA Slope` from caller-provided OHLCV data.
