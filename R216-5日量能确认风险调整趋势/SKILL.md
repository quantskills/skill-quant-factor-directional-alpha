---
name: quant-real-factor-5d-volume-confirmed-risk-adjusted-trend
description: Use when computing the 5D Volume Confirmed Risk-Adjusted Trend factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Risk-Adjusted Trend

Use this Skill to compute `5日量能确认风险调整趋势` / `5D Volume Confirmed Risk-Adjusted Trend` from caller-provided OHLCV data.
